...
MONITOR=$(echo "NORMAL" | rofi -i -dmenu -p "Select setup:")
...
ln -sf $GIT_PATH/linux-setup/miscellaneous/arandr_scripts/tomas/desktop2_$MONITOR_LOWERCASE.sh ~/.monitor.sh
